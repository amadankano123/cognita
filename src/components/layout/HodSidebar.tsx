...
import {
  LayoutDashboard, Users, UserCheck, Settings, Building2,
  ChevronLeft,
} from "lucide-react";
...
const navItems = [
  { title: "Overview", path: "/hod/overview", icon: LayoutDashboard },
  { title: "Supervisors", path: "/hod/supervisors", icon: UserCheck },
